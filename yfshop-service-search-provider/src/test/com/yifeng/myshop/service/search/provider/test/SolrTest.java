package com.yifeng.yfshop.service.search.provider.test;
import com.yifeng.yfshop.service.search.domain.TbItemResult;
import com.yifeng.yfshop.service.search.provider.MyShopServiceSearchProviderApplication;
import com.yifeng.yfshop.service.search.provider.mapper.TbItemResultMapper;
...
public class SolrTest {
    ...
    final String urlString = "http://192.168.1.190:8983/solr/ik_core";
    ...
    public void testSearch() {
        ...
        try {
            ...
            // QueryResponse queryResponse =    solr.query("http://192.168.1.190:8983/solr/ik_core",query);
